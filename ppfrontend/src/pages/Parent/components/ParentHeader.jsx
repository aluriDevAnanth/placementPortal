        ...
        <div className='ms-auto d-flex'>
          <div className="collapse navbar-collapse me-4" id="navbarSupportedContent">
            <div className="dropdown ">
              <button className="btn dropdown-toggle rounded-3 text-white" style={{ backgroundColor: "#696747" }} type="button" data-bs-toggle="dropdown" aria-expanded="false"> {user.name}'s Parent </button>
